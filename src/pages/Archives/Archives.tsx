...
import SearchArchiveDocument from "../../components/archives/SearchArchiveDoc";
    ...
    <>
      ...
      <div className="space-y-6">
        <ComponentCard
          ...
          <SearchArchiveDocument ref={searchRef} onSearch={handleSearch} />
        </ComponentCard>
        <ComponentCard title="Document Table">
          <ArchiveDocumentTable documents={Documents} setDocuments={setDocuments} />
        </ComponentCard>
      </div>
    </>
  );
