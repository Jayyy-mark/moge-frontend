...
import { RecycleDocumentSearch } from "../../interfaces/document";
import { useSelectOptions } from "../../hooks/useSelectOptions";
import { helper } from "../../helpers/utils";
import "react-datepicker/dist/react-datepicker.css";
import DatePicker from "../form/date-picker";

const SearchRecycleDocument = forwardRef(({ onSearch }: any, ref) => {

    const [form, setForm] = useState<RecycleDocumentSearch>({
        document_id: "",
        document_name: "",
        staff_id: "",
        dtype_id: "",
    ...
    const recycleRef = useRef<any>(null);
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="relative">
                ...
                <DatePicker
                    ref={rangeRef}
                    id="recycled-date-range"
                    mode="range"
                    label="Recycled date range"
...
export default SearchRecycleDocument;