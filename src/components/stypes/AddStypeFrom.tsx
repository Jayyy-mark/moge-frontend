...
export default function AddStypeForm() {
    ...
    const [form, setFrom] = useState<AddStype>({
        stype_name: "",
    });

    const handleSubmit = async() =>{
        if(form.stype_name == null){
            alert("Please enter stype name!");
            return;
        }
        ...
        try {
            ...
            console.log(error);
            toast.error(error?.message || "Falied to create stype!"); 
        }
    };
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                    ...
                    <Input
                        ...
                        onChange={(e) => setFrom({ ...form, stype_name: e.target.value })}
                    ></Input>
                </div>
